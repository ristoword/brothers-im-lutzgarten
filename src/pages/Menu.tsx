      ...
      <div className="relative h-72 bg-[#1a3a2a] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pb-12 w-full">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-[#c8a96e] text-xs tracking-widest uppercase">Cucina italiana autentica</span>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="flex flex-wrap gap-3 justify-center mb-16">
          {categories.map(cat => (
            ...
            >
              {cat !== 'Tutti' && categoryEmojis[cat] + ' '}{cat}
            </motion.button>
          ))}
        </div>
        ...
        <div className="flex flex-wrap gap-6 justify-center mb-12 p-4 bg-white rounded-2xl border border-gray-100 shadow-sm">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>Consigliato dallo chef</span>
          </div>
          <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>Opzione vegetariana disponibile</span>
          </div>
        </div>
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-1.5">
                            <h3 className="font-serif text-lg font-bold text-[#1a3a2a] group-hover:text-white transition-colors">
                              {item.name}
                            </h3>
                            {item.badge === 'chef' && (
                              <span className="bg-[#c8a96e] text-[#1a3a2a] text-[10px] px-2 py-0.5 rounded-full font-bold flex items-center gap-1">
                                <Award size={9} /> Chef
                              </span>
                            )}
                            {item.badge === 'popular' && (
                              <span className="bg-[#8b1a1a] text-white text-[10px] px-2 py-0.5 rounded-full font-bold flex items-center gap-1">
                                <Flame size={9} /> Top
                              </span>
                            )}
                          </div>
                        ...
                        <div className="flex-shrink-0 text-right">
                          <span className="font-serif text-2xl font-bold text-[#c8a96e]">
        ...
        <div className="mt-16 p-8 bg-[#1a3a2a] rounded-2xl text-center">
          <p className="text-[#c8a96e] font-serif text-lg italic mb-2">
            "Tutti i nostri piatti sono preparati con ingredienti freschi e di stagione"
          </p>
          <p className="text-white/50 text-sm">
            Allergie e intolleranze? Il nostro staff è sempre a disposizione. · Tutti i prezzi includono IVA.
          </p>
        </div>
      </div>
    </div>
